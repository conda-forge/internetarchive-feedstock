About internetarchive-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/internetarchive-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/internetarchive-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add internetarchive
# for installing globally
pixi global install internetarchive
```
...
It is possible to list all of the versions of `internetarchive` available on your platform:
...
```
pixi search internetarchive --channel conda-forge
```
